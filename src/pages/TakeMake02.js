  ...
  return (
	<div>
	  <h1>Take&Make 2</h1>
		...
		<p>Test your LEDs and the battery. Each LED has two prongs.  One is slightly longer than the other.  The longer prong is positive. The short prong is negative. </p>
		<br/>
		<img className="transform scale-100" src={img02} alt="logo" />
		<br/>

		<p>Place the battery between the two prongs with the positive prong touching the positive side of the battery and the negative prong touching the negative side.</p>
		<br/>
		...
		<p>Use your push pin or needle to poke small holes in your light bulb for the LEDs.  The holes should be parallel to each other to create the parallel circuit. For example, you can put one whole in the gear and one in the painters pallet.</p>
		<br/>
		...
		<p>Thread the prongs of each LED through one of the holes in the paper light bulb.  </p>
		<br/>
		<img className="transform scale-100" src={img07} alt="logo" />
		<br/>

		<p>Turn over the paper and bend back each prong - make sure that both positive prongs are on the same side! In this example the longer prongs(+)  are on the left side.</p>
		<br/>
		<img className="transform scale-100" src={img08} alt="logo" />
		<br/>

		<p>Take the copper tape and peel back the white backing. Attach an 4 inch piece (approx)  of copper tape horizontally from the middle of the triangle formed by the fold in the paper past the end of the far prong.</p>
		<br/>
		<img className="transform scale-100" src={img09} alt="logo" />
		<br/>

		<p>Attach a vertical piece of copper tape to the end of the horizontal piece down to the second LED prong.</p>
		<br/>
		<img className="transform scale-100" src={img10} alt="logo" />
		<br/>

		<p>Place copper tape under each prong. The tape shouldn’t meet at the LED.</p>
		<br/>
		<img className="transform scale-100" src={img11} alt="logo" />
		<br/>

		<p>Once you have tape under each prong you’ll add another piece of tape over the prong - like a sandwich! The tape on the top left prong should be a little longer than the others.</p>
		<br/>
		<img className="transform scale-100" src={img12} alt="logo" />
		<br/>

		<p>Add one more vertical piece of copper tape to attach the two prongs on the left side.</p>
		<br/>
		<img className="transform scale-100" src={img13} alt="logo" />
		<br/>

		<p>Now it’s time to test your circuit!  Place your battery on the tail of the top left prong.  If the prongs on the left are positive (the longer prongs) place the positive side of the battery facing down.  If negative, do the reverse! </p>
		<br/>
		<img className="transform scale-100" src={img14} alt="logo" />
		<br/>

		<p>Fold the Paper at the crease and your LEDs should light! </p>
		<p>Make sure that the circuit is closed by checking that the copper tape on the fold touches the battery.</p>
		<br/>
		...
		<ol>
			...
			<li>Check that tape connects all around the circuit EXCEPT at the LEDs.</li>
			<li>If none of the above you may need to remove some tape to check that both positive prongs are on the same side.</li>
		</ol>
